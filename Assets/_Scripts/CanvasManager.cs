...
public class CanvasManager : MonoBehaviour
{
    ...
    public void DisplayOnCanvas()
    {
        if (backgroundImage == null)
            return;
        IMG2Sprite spriteGenerator = new IMG2Sprite();
        Sprite newSprite = spriteGenerator.LoadNewSprite(saveManager.GetAIImagePath());

        backgroundImage.sprite = newSprite;
    }
}

//Open sourced from Freznosis @ UnityForums https://discussions.unity.com/t/generating-sprites-dynamically-from-png-or-jpeg-files-in-c/591103/5
internal class IMG2Sprite
{
